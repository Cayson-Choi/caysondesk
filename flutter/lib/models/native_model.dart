...
class PlatformFFI {
  ...
  CaysondeskImpl get ffiBind => _ffiBind;
  ...
  Future<void> init(String appType) async {
    ...
    final dylib = isAndroid
        ...
        : isLinux
            ? DynamicLibrary.open('librustdesk.so')
            : isWindows
                ? DynamicLibrary.open('libcaysondesk.dll')
                :
  ...
  void _startListenEvent(CaysondeskImpl rustdeskImpl) {
    final appType =

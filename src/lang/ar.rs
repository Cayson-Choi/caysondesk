...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "جاري الاتصال بشبكة CaysonDesk..."),
        ...
        ("install_tip", "بسبب صلاحيات تحكم حساب المستخدم. CaysonDesk قد لا يعمل بشكل صحيح في جهة البعيد في بعض الحالات. لتفادي ذلك. الرجاء الضغط على الزر ادناه لتثبيت CaysonDesk في جهازك."),
        ("Click to upgrade", "اضغط للارتقاء"),
        ("Configure", "تهيئة"),
        ("config_acc", "لتتمكن من التحكم بسطح مكتبك البعيد, تحتاج الى منح CaysonDesk اذونات \"امكانية الوصول\"."),
        ("config_screen", "لتتمكن من الوصول الى سطح مكتبك البعيد, تحتاج الى منح CaysonDesk اذونات \"تسجيل الشاشة\"."),
        ...
        ("android_input_permission_tip1", "لكي يتمكن جهاز بعيد من التحكم بجهازك الـ Android عن طريق الفارة أو اللمس، يلزمك السماح لـ CaysonDesk باستخدام خدمة \"إمكانية الوصول\"."),
        ("android_input_permission_tip2", "يرجى الانتقال إلى صفحة إعدادات النظام التالية، والعثور على [الخدمات المثبتة]، وتشغيل خدمة [CaysonDesk Input]."),
        ...
        ("Turned off", "مطفئ"),
        ("Language", "اللغة"),
        ("Keep CaysonDesk background service", "ابق خدمة CaysonDesk تعمل في الخلفية"),
        ("Ignore Battery Optimizations", "تجاهل تحسينات البطارية"),
        ("android_open_battery_optimizations_tip", "اذا اردت تعطيل هذه الميزة, الرجاء الذهاب الى صفحة اعدادات تطبيق CaysonDesk, ابحث عن البطارية, الغ تحديد غير مقيد"),
        ...
        ("Show CaysonDesk", "عرض CaysonDesk"),
        ("This PC", "هذا الحاسب"),
        ("or", "او"),
        ("Elevate", "ارتقاء"),
        ...
        ("config_input", "لتتمكن من التحكم بسطح المكتب البعيد. يجب من CaysonDesk اذونات \"مراقبة المدخلات\"."),
        ("config_microphone", "لتتمكن من التحدث. يجب منح CaysonDesk اذونات \"تسجيل الصوت\"."),
        ...
        ("still_click_uac_tip", "لازال يحتاج المستخدم البعيد للضغط على موافق في نافذة تحكم حساب المستخدم في CaysonDesk الذي يعمل."),
        ...
        ("verify_rustdesk_password_tip", "تحقق من كلمة مرور CaysonDesk"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "ترقية خادم CaysonDesk Pro إلى {}"),
        ...
        ("enable-bot-tip", "تمكين البوت للتفاعل مع CaysonDesk"),
        ...
        ("About CaysonDesk", "حول CaysonDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "ترقية عميل CaysonDesk البعيد إلى {}"),

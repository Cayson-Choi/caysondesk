...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään CaysonDesk verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa CaysonDesk ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi CaysonDeskin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava CaysonDeskille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava CaysonDeskille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten CaysonDesk daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota CaysonDeskille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli CaysonDesk ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "CaysonDesk palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa CaysonDeskin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "CaysonDesk palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep CaysonDesk background service", "Pidä CaysonDeskin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista CaysonDeskin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show CaysonDesk", "Näytä CaysonDesk"),
        ...
        ("verify_rustdesk_password_tip", "Vahvista CaysonDesk salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "CaysonDesk ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Päivitä CaysonDesk Server Pro versioon {} jatkaaksesi."),
        ...
        ("About CaysonDesk", "Tietoa CaysonDeskistä"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Päivitä etä-CaysonDesk-asiakasversioon {} yhteensopivuuden takaamiseksi"),

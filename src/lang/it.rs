...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete CaysonDesk..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), CaysonDesk potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare CaysonDesk a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a CaysonDesk il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a CaysonDesk il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a CaysonDesk di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [CaysonDesk Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep CaysonDesk background service", "Mantieni il servizio di CaysonDesk in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione CaysonDesk, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show CaysonDesk", "Visualizza CaysonDesk"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ("Elevate", "Eleva"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a CaysonDesk 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a CaysonDesk."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di CaysonDesk."),
        ...
        ("verify_rustdesk_password_tip", "Conferma password CaysonDesk"),
        ...
        ("Exit", "Esci da CaysonDesk"),
        ("Open", "Apri CaysonDesk"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare CaysonDesk e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Aggiorna CaysonDesk Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di CaysonDesk come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da CaysonDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra CaysonDesk è aperta"),
        ...
        ("About CaysonDesk", "Info su CaysonDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Aggiorna il client CaysonDesk remoto alla versione {} o successiva!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per impostazione predefinita, CaysonDesk verifica il certificato del server per i protocolli usando TLS.\nCon questa opzione abilitata, CaysonDesk salterà il passaggio di verifica e procederà in caso di errore di verifica."),
        ("Disable UDP", "Disabilita UDP"),
        ("disable-udp-tip", "Controlla se usare solo TCP.\nQuando questa opzione è abilitata, CaysonDesk non userà più UDP 21116, verrà invece usato TCP 21116."),
        ("server-oss-not-support-tip", "Nota: il sistema operativo del server CaysonDesk non include questa funzionalità."),

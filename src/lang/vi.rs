...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới CaysonDesk..."),
        ...
        ("install_tip", "Do cơ chế UAC, CaysonDesk có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt CaysonDesk vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho CaysonDesk."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho CaysonDesk."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [CaysonDesk Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep CaysonDesk background service", "Giữ dịch vụ CaysonDesk chạy nền"),
        ...
        ("Show CaysonDesk", "Hiện CaysonDesk"),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu CaysonDesk"),
        ...
        ("scam_text2", "Chỉ sử dụng CaysonDesk với những người bạn thực sự tin tưởng."),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ CaysonDesk mở"),
        ...
        ("floating_window_tip", "Giữ CaysonDesk trên cùng"),
        ...
        ("About CaysonDesk", "Về CaysonDesk"),
